        ...
        <>
           <Stack spacing={2} alignItems="center" justifyContent="center" wrap="flexWrap" divider={<StackDivider borderColor='gray.200' />} borderRadius="lg" padding="15px" shadow="md">
                <Box>
                        ...
                        <Image src={catalogo?.imagen} alt={ catalogo?.nombre} boxSize="200"></Image>
                </Box>

                <Box>
                    
                    <Text fontSize='md' textAlign="center">{catalogo?.descripcion}</Text>
                    <Text fontSize='md' textAlign="center">$ {catalogo?.precio}</Text>
                </Box>  
           </Stack>
        </>
    )
